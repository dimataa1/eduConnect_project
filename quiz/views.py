...
def textChatBot(request):
    ...
    if api_key is not None and request.method == 'POST':
        ...
        if user_input:
            prompt = f"Въз основа на следното описание: '{user_input}', предостави кратко описание на най-важните точки по темата. След това генерирай между 6 и 15 въпроса с отговори на български, които могат да бъдат използвани за тест върху темата във формат въпроса и след това отговора всеки въпрос на отделен ред."
